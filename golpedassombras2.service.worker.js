...
/** @type {string} */
const CACHE_VERSION = '1783037151|2270872149';
/** @type {string} */
const CACHE_PREFIX = 'Golpe das Sombra-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Golpe das Sombras2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Golpe das Sombras2.html","Golpe das Sombras2.js","Golpe das Sombras2.offline.html","Golpe das Sombras2.icon.png","Golpe das Sombras2.apple-touch-icon.png","Golpe das Sombras2.audio.worklet.js","Golpe das Sombras2.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Golpe das Sombras2.wasm","Golpe das Sombras2.pck","Golpe das Sombras2.side.wasm"];
